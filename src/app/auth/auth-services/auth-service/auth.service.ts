...
export class AuthService {
  ...
  getUserById(): Observable<any> {
    ...
    return this.http.get<[]>(`${BASIC_URL}api/user/${userId}`, {
      ...
      tap((_) => this.log('Usuario recuperado con éxito')),
      catchError(this.handleError<[]>('Error al obtener el usuario', []))
    );
  }
  ...
  updateUser(data): Observable<any> {
    return this.http.post<[]>(`${BASIC_URL}api/update`, data, {
      ...
      tap((_) => this.log('Usuario actualizado con éxito')),
  ...
  updatePassword(changePasswordDto: any): Observable<any> {
    ...
    return this.http.post<[]>(`${BASIC_URL}api/updatePassword`, changePasswordDto, {
      ...
      tap((_) => this.log('Contraseña actualizada exitosamente')),
      catchError(this.handleError<[]>('Error al actualizar la contraseña', []))
    );
  }
  ...
  private log(message: string): void {
    console.log(`Servicio de autenticación de usuarios: ${message}`);
  }
